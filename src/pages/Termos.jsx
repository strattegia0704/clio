    ...
    <>
      ...
      <Container>
        <div>
          ...
          <p className="sobre">
            <span>
              Ao acessar ao site <a href="https://clio.vercel.app">Clio</a>,
          ...
          <p className="sobre">
            <span>
              ...
              materiais (informações ou software) no site Clio , apenas para
          ...
          <p className="sobre">
            <span>
              ...
              dessas restrições e poderá ser rescindida por Clio a qualquer
          ...
          <ol>
            <li className="li-marc">
              <span>
                Os materiais no site da Clio são fornecidos 'como estão'. A Clio
            ...
            <li className="li-marc">
              <span>
                Além disso, a Clio não garante ou faz qualquer representação
          ...
          <p className="sobre">
            <span>
              Em nenhum caso a Clio ou seus fornecedores serão responsáveis
              ...
              Clio, mesmo que Clio ou um representante autorizado da Clio tenha
          ...
          <p>
            <span>
              Os materiais exibidos no site da Clio podem incluir erros
              técnicos, tipográficos ou fotográficos. A Clio não garante que
              qualquer material em seu site seja preciso, completo ou atual. A
              Clio pode fazer alterações nos materiais contidos em seu site a
              qualquer momento, sem aviso prévio. No entanto, a Clio não se
          ...
          <p className="sobre">
            <span>
              A Clio não analisou todos os sites vinculados ao seu site e não é
              responsável pelo conteúdo de nenhum site vinculado. A inclusão de
              qualquer link não implica endosso por Clio do site. O uso de
          ...
          <div className="more">
            ...
            <p>
              <span>
                <em>
                  A Clio pode revisar estes termos de serviço do site a qualquer
            ...
            <p>
              <span>
                <em>
                  ...
                  com as leis da Clio e você se submete irrevogavelmente à
