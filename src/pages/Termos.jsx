                ...
                <>
                        ...
                        <Container>
                                <div>
                                        ...
                                        <hr />
                                        <p className='sobre'><span>Ao acessar ao site <a href="https://clio.vercel.app">Clio</a>, concorda em
                                        ...
                                        <hr />
                                        <p className='sobre'><span>É concedida permissão para baixar temporariamente uma cópia dos materiais
                                        ...
                                        <ol>
                                                <li className='li-marc'><span>modificar ou copiar os materiais;&nbsp;</span></li>
                                                <li className='li-marc'><span>usar os materiais para qualquer finalidade comercial ou para exibição
                                                        pública (comercial ou não comercial);&nbsp;</span></li>
                                                <li className='li-marc'><span>tentar descompilar ou fazer engenharia reversa de qualquer software
                                                        contido no site Clio;&nbsp;</span></li>
                                                <li className='li-marc'><span>remover quaisquer direitos autorais ou outras notações de propriedade dos
                                                        materiais; ou&nbsp;</span></li>
                                                <li className='li-marc'><span>transferir os materiais para outra pessoa ou 'espelhe' os materiais em
                                                        qualquer outro servidor.</span></li>
                                        </ol>
                                        <p className='sobre'><span>Esta licença será automaticamente rescindida se você violar alguma dessas
                                        ...
                                        <hr />
                                        <ol>
                                                <li className='li-marc'><span>Os materiais no site da Clio são fornecidos 'como estão'. A Clio não oferece
                                                ...
                                                <li className='li-marc'><span>Além disso, a Clio não garante ou faz qualquer representação relativa à
                                        ...
                                        <hr />
                                        <p className='sobre'><span>Em nenhum caso a Clio ou seus fornecedores serão responsáveis ​​por quaisquer
                                        ...
                                        <hr />
                                        <p className='sobre'><span>A Clio não analisou todos os sites vinculados ao seu site e não é responsável
