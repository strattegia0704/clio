    ...
    <>
      ...
      <Container>
        <div className='container-other'>
            ...
            <hr />
            <p><span>A sua privacidade é importante para nós. É política da Clio respeitar a sua
            ...
            <p><span>Solicitamos informações pessoais apenas quando realmente precisamos delas para
            ...
            <p><span>Apenas retemos as informações coletadas pelo tempo necessário para fornecer o
            ...
            <p><span>Não compartilhamos informações de identificação pessoal publicamente ou com
                    terceiros, exceto quando exigido por lei.</span></p>
            <p><span>O nosso site pode ter links para sites externos que não são operados por nós.
                ...
                >.</span></p>
            <p><span>Você é livre para recusar a nossa solicitação de informações pessoais,
                    entendendo que talvez não possamos fornecer alguns dos serviços desejados.</span></p>
            <p><span>O uso continuado de nosso site será considerado como aceitação de nossas
            ...
            <p><span>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que
