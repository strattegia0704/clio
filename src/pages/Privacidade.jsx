    ...
    <>
      ...
      <Container>
        <div className="container-other">
          ...
          <p className="sobre">
            <span>
              A sua privacidade é importante para nós. É política da Clio
              respeitar a sua privacidade em relação a qualquer informação sua
              que possamos coletar no site{" "}
              <a href="https://clio.vercel.app">Clio</a>, e outros sites que
          ...
          <p className="sobre">
            ...
            políticas de privacidade<span>.</span>
          </p>
          <p className="sobre">
            <span>
          ...
          <p className="sobre">
            <span>
              ...
              informação que a Clio oferece no site e com caráter enunciativo,
              mas não limitativo:
            </span>
          </p>
          <ul>
            ...
            <li className="li-marc">
              <span>
                ...
                xenofóbica, ERROR ou azar, qualquer tipo de pornografia ilegal,
            ...
            <li className="li-marc">
              <span>
                ...
                (softwares) da Clio, de seus fornecedores ou terceiros, para
